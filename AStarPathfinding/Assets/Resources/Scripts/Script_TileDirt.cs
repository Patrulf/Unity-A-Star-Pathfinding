...
public class Script_TileDirt : Script_ITile {
	...
	public Script_TileDirt(Script_GameManager p_gameManager,Script_Grid p_grid, Vector3Int p_position)
	{
		_meshObjectName = "ObjectDirt";
		_meshObjectColor = new Color (1.0f, 0.5f, 0.0f);
