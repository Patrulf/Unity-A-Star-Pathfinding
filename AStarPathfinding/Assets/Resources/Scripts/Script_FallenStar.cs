...
public class Script_FallenStar : Script_IEntity{
	...
	public Script_FallenStar(Script_GameManager p_gameManager,Script_Grid p_grid, Vector3Int p_position)
	{
		_meshObjectName = "ObjectTradingPost";
		_meshObjectColor = new Color (0.2f, 0.0f, 0.0f);
